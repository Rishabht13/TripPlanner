      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded shadow p-6 space-y-4">
          ...
          <div className="text-sm text-gray-600">
            Pay to <span className="font-semibold text-gray-900">Paytm UPI: paytm.business@example.com</span>. Enter your UPI ID so we can send a collect request or confirm your transfer.
          </div>
          <div>
